## FoodWize
The White House mandated all government agencies enable open data. The FDA created openFDA in support of this initiative. INCATech has consumed the restful api and built a consumer focused site around the food recall api.
